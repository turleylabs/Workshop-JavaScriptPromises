...
export const getRatesSync = () => {
    return rates;
};

export const getInterestBearingDebtRatesSync = () => {
    return interestBearingDebtRates;
};

export const updateNewInterestBearingDebtRatesSync = (newRates) => {
}

export const getRates = (callback) => {
    const err = null;
    setTimeout(() => callback(err, rates), 500);
};

export const getInterestBearingDebtRates = (callback) => {
    const err = null;
    setTimeout(() => callback(err, interestBearingDebtRates), 500);
};

export const updateNewInterestBearingDebtRates = (newRates, callback) => {
    const err = null;
    setTimeout(() => callback(err), 500);
}